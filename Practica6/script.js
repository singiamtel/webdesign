...
function load_data(){
	...
	for (var i = 0 ; i < json.results.length; i++) {
		...
		div_actors.innerHTML = "Henry Fonda, Lee J. Cobb, Jack Warden, E.G. Marshall, Martin Balsam, Ed Begley, John Fiedler, Robert Webber, ...";
		...
		div_director.innerHTML = `<a href="">Francis Ford Coppola</a>`;

		div_info.className = "info";
		div_info.innerHTML = `<strong>${json.results[i].title} (${json.results[i].release_date.substring(0, 4)})</strong>`
